...
public class PersistencePayConfiguration {
    ...
    public static final String DAO_PACKAGES = "io.github.toquery.example.spring.data.jpa.multiple.databases.modules.pay.dao";
    public static final String[] ENTITY_PACKAGES = {"io.github.toquery.example.spring.data.jpa.multiple.databases.modules.pay.entity"};
    ...
    @Bean
    public PlatformTransactionManager payTransactionManager(@Qualifier("payEntityManagerFactory") LocalContainerEntityManagerFactoryBean payEntityManagerFactory) {
